        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.MessageEmbed()
                    ...
                    .setFooter({ text: `© desarollado por berna | 2022`, iconURL: `https://images-ext-2.discordapp.net/external/G2O3wNQkWm957e5Qv3xUpceIQozUug5Z_dfyP9aIKYQ/%3Fsize%3D4096/https/cdn.discordapp.com/avatars/282942681980862474/c2136834f15c6f8633c19c72feeb2427.webp` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional en Desarollo por \`Berna#5919\``)
            .addField(`❓ **__¿Quién soy?__**`, `👋 Hola **${message.author.username}**, mi nombre es **__${client.user.username}__**\n🤯 Soy un BOT MULTIFUNCIONAL IncluyCIÓN\n> MODERendo:\n> **ADMINISTRAACIÓN\n> MÚSICA**\n*y mucho más!*`)
            .addField(`📈 **__ESTADÍSTICAS__**`, `⚙ **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 Desarollado por **[berna](https://youtu.be/GSr28vUbJxw)**`)
            .addField(`✍ **__SUPORT SERVER__**`, `[\`UNETE A MI SUPORT SERVER\`](https://discord.gg/mB4x8mMftn)`)
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© desarollado por berna | 2022`, iconURL: `https://images-ext-2.discordapp.net/external/G2O3wNQkWm957e5Qv3xUpceIQozUug5Z_dfyP9aIKYQ/%3Fsize%3D4096/https/cdn.discordapp.com/avatars/282942681980862474/c2136834f15c6f8633c19c72feeb2427.webp` })
